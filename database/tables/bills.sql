CREATE TABLE IF NOT EXISTS `bills` (
    ...
    CONSTRAINT `fk_bills_user_id` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
...
INSERT INTO `bills` (`id`, `user_id`, `id_group`, `name`, `value`, `date`)
VALUES
    (1, 10, 1, 'Electricity March', 124.90, '2026-03-15'),
    (2, 10, 2, 'Streaming Annual Plan', 89.99, '2026-02-01'),
    (3, 10, 3, 'Car Insurance', 312.50, '2026-01-20')
