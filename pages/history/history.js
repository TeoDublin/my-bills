    ...
    function createPageController() {
        ...
        return {
            ...
            bindEvents: function () {
                ...
                this.dom.tabButtons.forEach((button) => {
                    ...
                    this.bindListener(button, 'click', () => {
                        ...
                        const tab = button.dataset.tab || 'historic';
                        this.openTab(tab);
                    });
                });
            },
            ...
            openTab: function (tab) {
                ...
                const currentTab = this.dom.root ? (this.dom.root.dataset.activeTab || 'historic') : 'historic';
            ...
            loadActiveTabModule: function () {
                ...
                const tab = this.dom.root ? (this.dom.root.dataset.activeTab || 'historic') : 'historic';
